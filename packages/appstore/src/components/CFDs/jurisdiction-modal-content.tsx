...
import { jurisdiction_contents } from './jurisdiction-contents';
import { useStores } from 'Stores/index';
import { TRootStore, TExistingData } from 'Types';
...
const JurisdictionModalContent = ({
    ...
    const { real_financial_accounts_existing_data, real_synthetic_accounts_existing_data } = modules.cfd;
    const card_classname = `cfd-jurisdiction-card--${account_type}`;
        ...
        const is_available =
            account_type === 'synthetic'
                ? real_synthetic_accounts_existing_data?.some(
                      (account: TExistingData) => account.landing_company_short === type_of_card
                  )
...
export default observer(JurisdictionModalContent);
